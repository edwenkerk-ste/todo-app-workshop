...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({ success: false, error: 'Failed to load todo.' }, { status: 500 })
  }
}
...
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json({ success: false, error: 'Failed to update todo. Please try again.' }, { status: 500 })
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json({ success: false, error: 'Failed to delete todo. Please try again.' }, { status: 500 })
  }
}
