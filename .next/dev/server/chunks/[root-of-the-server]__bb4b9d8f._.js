...
"[project]/lib/timezone.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getSingaporeNow() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2d$tz$2f$dist$2f$esm$2f$toZonedTime$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toZonedTime"])(new Date(), SG_TZ);
}
function parseSingaporeLocalIso(value) {
    const parsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseISO"])(value);
    // `fromZonedTime` treats the input as a local time in the given zone.
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2d$tz$2f$dist$2f$esm$2f$fromZonedTime$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fromZonedTime"])(parsed, SG_TZ);
}
function formatSingaporeDate(date) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2d$tz$2f$dist$2f$esm$2f$formatInTimeZone$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["formatInTimeZone"])(date, SG_TZ, 'yyyy-MM-dd HH:mm');
}
function formatSingaporeForInput(date) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2d$tz$2f$dist$2f$esm$2f$formatInTimeZone$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["formatInTimeZone"])(date, SG_TZ, "yyyy-MM-dd'T'HH:mm");
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$timezone$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/timezone.ts [app-route] (ecmascript)");
;
;
const prioritySchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
    'high',
    'medium',
    'low'
]);
const recurrencePatternSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
    'daily',
    'weekly',
    'monthly',
    'yearly'
]);
const createTodoSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    title: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(1, {
        message: 'Title is required'
    }),
    due_date: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional().refine((val)=>val ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$timezone$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isFutureSingaporeIso"])(val) : true, {
...
const updateTodoSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    title: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().trim().min(1).optional(),
    due_date: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().nullable().optional().refine((val)=>{
        if (val === null || val === undefined || val === '') return true;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$timezone$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isFutureSingaporeIso"])(val);
    }, {
        message: 'Due date must be at least 1 minute in the future (Singapore time)'
    }),
    priority: prioritySchema.optional(),
...
"[project]/lib/recurrence.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function toSgParts(utcIso) {
    const local = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2d$tz$2f$dist$2f$esm$2f$formatInTimeZone$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["formatInTimeZone"])(new Date(utcIso), SG_TZ, "yyyy-MM-dd'T'HH:mm:ss");
...
function toUtcIsoFromSgParts(parts) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$timezone$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseSingaporeLocalIso"])(localIso).toISOString();
}
function calculateNextDueDate(dueDateUtcIso, pattern) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$timezone$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/timezone.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$recurrence$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/recurrence.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(_request, context) {
    ...
    const todo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTodoById"])(id);
    if (!todo) {
...
async function PUT(request, context) {
    const { id } = await context.params;
    const existing = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTodoById"])(id);
    if (!existing) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: 'Todo not found'
    ...
    const parseResult = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateTodoSchema"].safeParse(body);
    ...
    if (payload.due_date) {
        payload.due_date = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$timezone$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseSingaporeLocalIso"])(payload.due_date).toISOString();
    }
    if (payload.is_recurring === false) {
        payload.recurrence_pattern = null;
    }
    const shouldCreateNextInstance = payload.completed === true && existing.completed === false && existing.is_recurring && Boolean(existing.recurrence_pattern) && Boolean(existing.due_date);
    const updated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateTodo"])(id, payload);
    if (!updated) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: 'Todo not found'
    ...
    if (shouldCreateNextInstance && existing.due_date && existing.recurrence_pattern) {
        const nextDueDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$recurrence$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["calculateNextDueDate"])(existing.due_date, existing.recurrence_pattern);
        createdRecurringTodo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createTodo"])({
...
async function DELETE(_request, context) {
    const { id } = await context.params;
    const success = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteTodo"])(id);
    if (!success) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: 'Todo not found'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bb4b9d8f._.js.map