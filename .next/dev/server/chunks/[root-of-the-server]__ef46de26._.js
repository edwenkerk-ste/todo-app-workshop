...
;
async function GET() {
    const todos = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllTodos"])();
...
async function POST(request) {
    ...
    const parseResult = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createTodoSchema"].safeParse(body);
    if (!parseResult.success) {
        const message = parseResult.error.issues.map((e)=>e.message).filter(Boolean).join('; ');
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: message || 'Invalid todo payload'
        }, {
            status: 400
        });
    }
    const { title, due_date, priority, is_recurring, recurrence_pattern } = parseResult.data;
    const dueDateIso = due_date ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$timezone$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseSingaporeLocalIso"])(due_date).toISOString() : null;
    const todo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createTodo"])({
        title,
        due_date: dueDateIso,
        priority,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ef46de26._.js.map